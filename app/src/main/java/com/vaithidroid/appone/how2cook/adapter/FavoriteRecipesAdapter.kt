...
import com.vaithidroid.appone.how2cook.databinding.FavoriteRecipesRowLayoutBinding
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.favoriteRecipesRowLayout.setOnClickListener {
            if (multiSelection) {
                ...
                val action =
                    FavoriteRecipesFragmentDirections.actionFavoriteFoodFragmentToDetialsActivity(
